...
module Main = 
    let lvl : Lazy<GHC.Types.ZMZN<GHC.Types.Int>> = 
        lazy
        (
            (Control.Exception.Base.patError<GHC.Types.ZMZN<GHC.Types.Int>> ("Main.hs:8:0-39|function the_filter"))
        )
    
    let lvl1 : Lazy<GHC.Types.ZMZN<GHC.Types.Int>> -> Lazy<GHC.Types.ZMZN<GHC.Types.Int>> -> GHC.Types.ZMZN<GHC.Types.Int> = 
        fun xaIB ysaIC ->
            (GHC.Types.ZC  ((lazy (GHC.List.head<GHC.Types.Int> (xaIB))), (ysaIC)))
    
    let lvl2 : Lazy<GHC.Types.ZMZN<GHC.Types.Int>> -> GHC.Types.ZMZN<GHC.Types.Int> = 
        fun dsdCy ->
            let 
    ...
    let lvl3 : Lazy<GHC.Types.Int> -> GHC.Types.Int = 
        fun xafx ->
            let 
    ...
    let lvl4 : Lazy<GHC.Types.Int> = 
        lazy
        (
            (GHC.Types.Izh (2))
        )
    
    let lvl5 : Lazy<GHC.Types.ZMZN<GHC.Types.Int>> = 
        lazy
        (
            (GHC.List.iterate<GHC.Types.Int> (lvl3) (lvl4))
        )
    
    let lvl6 : Lazy<GHC.Types.ZMZN<GHC.Types.Int>> = 
        lazy
        (
            (GHC.List.iterateFB<GHC.Types.ZMZN<GHC.Types.Int>, GHC.Types.ZMZN<GHC.Types.Int>> (lvl1) (lvl2) (lvl5))
        )
    
    let lvl7 : Lazy<GHC.Types.ZMZN<GHC.Types.Char>> = 
        lazy
        (
            let 
                waRk : GHC.Types.Int = (GHC.List.sub<GHC.Types.Int> (lvl6) (1500))
            in
                match waRk with
                | GHC.Types.Izh (wwaRm) -> 

...
module Main = 
    ...
    let private a4 : GHC.Prim.Statezh<GHC.Prim.RealWorld> -> GHC.Prim.Z2H<GHC.Prim.Statezh<GHC.Prim.RealWorld>, GHC.Unit.Z0T> = 
        fun etaaTg ->
            let rec primes : Lazy<GHC.Types.ZMZN<GHC.Types.Int>> = 
                lazy
                (
                    let rec wheelsrfzz : Lazy<GHC.Types.ZMZN<Wheel>> = 
                        lazy
                        (
                            (GHC.Types.ZC  ((a2r15K), (lazy (GHC.List.zzipWith<Wheel, GHC.Types.Int, Wheel> (lvl3r15S) (wheelsrfzz) (primes)))))
                        )    
                    in
                        (sieverft (wheelsrfzz) (primes) (lazy (gor15U (primes))))
                )
            in
                match (GHC.IO.a29 (GHC.Handle.stdout) (lazy (match (GHC.List.sub<GHC.Types.Int> (primes) (300000)) with
                                                             | GHC.Types.Izh (wwaZZt) -> (GHC.Show.zdwshowSignedInt (0) (wwaZZt) (lazy (GHC.Types.ZMZN ))))) (etaaTg)) with
